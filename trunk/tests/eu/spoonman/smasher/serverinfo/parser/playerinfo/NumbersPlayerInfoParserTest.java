...
public class NumbersPlayerInfoParserTest {
    ...
    public void parseIntoServerInfoOne() throws ParserException {
        ServerInfoParser parser = new NumbersPlayerInfoParser("testingAtt", 0, TeamKey.RED_TEAM, ";");
    ...
    public void parseIntoServerInfoTwo() throws ParserException {
        ServerInfoParser parser = new NumbersPlayerInfoParser("teams", -2, TeamKey.BLUE_TEAM, " ");
